...
class TestCanonicalDependencyString:
    ...
    def test_regular_github_package_with_alias(self):
        """Alias (@) does NOT affect canonical string."""
        dep = DependencyReference.parse("owner/repo@myalias")
        assert dep.get_canonical_dependency_string() == "owner/repo"
    
    def test_regular_github_package_with_reference_and_alias(self):
        """Both reference and alias do NOT affect canonical string."""
    ...
    def test_ado_virtual_package(self):
        ...
        dep = DependencyReference.parse("dev.azure.com/myorg/myproject/myrepo/prompts/test.prompt.md")
        assert dep.get_canonical_dependency_string() == "myorg/myproject/myrepo/prompts/test.prompt.md"
    ...
    def test_ado_virtual_collection(self):
        ...
        assert dep.get_canonical_dependency_string() == "myorg/myproject/myrepo/collections/my-collection"
