...
def _install_apm_dependencies(
    ...
    callback_downloaded = builtins.set()
    ...
    def download_callback(dep_ref, modules_dir):
        ...
        try:
            ...
            callback_downloaded.add(dep_ref.get_unique_key())
            return install_path
        except Exception as e:
                    ...
                    if integrate_vscode or integrate_claude:
                        try:
                            ...
                            if not cached_commit:
                                cached_commit = getattr(cached_package, 'resolved_ref', None) or dep_ref.reference
